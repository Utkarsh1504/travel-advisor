    ...
    <footer className='footer'>
      <Container>
        <Row>
          ...
          <Col lg='3'>
            <h5 className='foorter__link-title'>Discover</h5>
          ...
          <Col lg='3'>
            <h5 className='foorter__link-title'>Quick Links</h5>
            <ListGroup className='footer__quick-links'>
              {
          ...
          <Col lg='12' className='text-center pt-5'>
            <p className='copyright'>Copyright {year}, designed and developed by Utkarsh, Prakhar, Abhinav. All rigths reserved.</p>
          </Col>
        </Row>
      </Container>
    </footer >
